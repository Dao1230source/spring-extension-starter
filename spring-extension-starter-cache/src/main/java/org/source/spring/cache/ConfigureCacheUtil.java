...
@Slf4j
@Data
public class ConfigureCacheUtil {

    public static Map<String, RedisCacheConfiguration> configMap(List<ConfigureCacheProperties> allCacheConfigs) {
        // 优先注解配置，后配置的覆盖
    ...
    private static Jackson2JsonRedisSerializer<Object> getValueSerializer(JavaType javaType) {
