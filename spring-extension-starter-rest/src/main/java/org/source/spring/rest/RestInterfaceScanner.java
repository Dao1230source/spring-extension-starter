...
public class RestInterfaceScanner extends ClassPathScanningCandidateComponentProvider {
    ...
    public static final String PROPERTIES_PREFIX_REST = "org.source.spring.request.retrofits.";
    ...
    protected OkHttpClient obtainOkHttpClient() {
        ...
        // todo 应该获取不到bean，待观察改进
        List<Interceptor> restInterceptors = new ArrayList<>(beanFactory.getBeansOfType(Interceptor.class).values());
        restInterceptors.add(new RestInterceptor(secretKey));
